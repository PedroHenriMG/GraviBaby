...
<div style="height: 100%;" class="row d-flex justify-content-center pt-2">
    
    <div style="height: 100%;" class="col-xs-12 col-sm-10 col-md-8 col-lg-6">
        <div style="height: 50%;" id="Teste" class="row d-flex justify-content-center pt-2">
            <div class="col-2">
                <form action="../controller/sair_sessao.php">
                    <button class="btn btn-danger" type="submit">X</button>
                </form>
            </div>
            <div class="mt-5 col-8 text-center d-flex flex-column align-items-center">
            ...
            <div style="height: 50%;" class="row d-flex justify-content-center mt-4">
